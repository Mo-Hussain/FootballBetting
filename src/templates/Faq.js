    ...
    <section id="wrapper">
        ...
        <div className="wrapper">
            <div className="inner">
                ...
                <p>At the moment we only provide support for football matches with the data provided directly from <a href="https://api.football-data.org/" target="_blank">football-data.org</a> which provides
                ...
                <p>As long as you have metamask installed and ether on the Rinkeby test network, you will be able to
										bet on our sports games from the <Link to="/make">'Make a Bet'</Link> tab. In order to get ether on the Rinkeby network
